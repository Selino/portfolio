  ...
  <div class="wrapper-content">
      ...
      <div class="donate-form shadow-div">
        ...
        <div class="progress-bar">
            <div class="progress-marker stage1 marker-off"></div>
            <div class="progress-marker stage2 marker-off"></div>
        	<div class="progress-marker stage3 marker-on"></div>
            <div id="progress-state1">Gift Information</div>
            <div id="progress-state2">Confirm Gift</div>
            <div id="progress-state3" class="progress-on">Receipt</div>
        </div>
        <br />
        </div>
